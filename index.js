...
exports.getFileNamesOfArray = function(params) {
    var blocks = [];
    /* htmlSrc содержит массив файлов */
    params.htmlSrc.map(function(file){
        var htmlSrc = fs.readFileSync(file, 'utf8');
        blocks = blocks.concat(getClasses(htmlSrc));
    });
